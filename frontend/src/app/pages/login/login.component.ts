...
@Component({
        ...
        <div class="login-right">
          <div class="glass-card login-card">
            ...
            <div class="logo-wrap anim-logo">
              <div class="logo-icon" [class.pulse]="!busy">
                <svg width="28" height="28" viewBox="0 0 32 32" fill="none">
                  <path d="M6 8h20M6 16h14M6 24h8" stroke="white" stroke-width="2.5" stroke-linecap="round"/>
                  <circle cx="26" cy="22" r="5" fill="#a78bfa"/>
                  <path d="M24 22l1.5 1.5L28 20" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </div>
            </div>
            ...
            <p class="hint-text anim-foot">
              Add <code>{{ origin }}/dashboard</code> to Supabase Auth → URL Configuration → Redirect URLs.
            </p>
          </div>
        </div>
      </div>
  ...
  styles: [`
    ...
    .theme-toggle {
      ...
      cursor: pointer; padding: 0.35rem 0.55rem; font-size: 1rem; transition: all .2s;
    }
